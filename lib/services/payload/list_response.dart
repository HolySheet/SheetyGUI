...
/// Json sent to a client in response to a request the listing of files. Example json (Excluding [BasicPayload]) is:
/// <pre>
///     {
///         "items": [
///              {
